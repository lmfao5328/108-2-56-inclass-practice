...
course_update$approve =  as.logical(course_update$approve)
...
course_update2$course = c(
  course_update2$course,
  teacher = "紀學檜"
)
course_update2
```
...
```{r ans32}
Pikachu_stats = as.vector(Pikachu$baseStats)
Pikachu_stats = as.numeric(Pikachu_stats)
class(Pikachu_stats)
Pikachu_stats
```
