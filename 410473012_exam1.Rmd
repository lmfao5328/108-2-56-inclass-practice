...
```{r ans1}
receipts300 = gsub(numerals_Gujarati[1], "1", receipts300)
receipts300 = gsub(numerals_Gujarati[2], "2", receipts300)
receipts300 = gsub(numerals_Gujarati[3], "3", receipts300)
receipts300 = gsub(numerals_Gujarati[4], "4", receipts300)
receipts300 = gsub(numerals_Gujarati[5], "5", receipts300)
receipts300 = gsub(numerals_Gujarati[6], "6", receipts300)
receipts300 = gsub(numerals_Gujarati[7], "7", receipts300)
receipts300 = gsub(numerals_Gujarati[8], "8", receipts300)
receipts300 = gsub(numerals_Gujarati[9], "9", receipts300)
receipts300

sum300 = sum(as.integer(receipts300))
sum300
```
...
```{r ans22}
poem_song[[136]]$author = poem_new$id
poem_song[[136]]$paragraphs = poem_new$`作者`
poem_song[[136]]$title = poem_new$`詩文`
poem_song[[136]]$id = poem_new$`主題`
...
```{r ans33}
a = "2020年"
post$comments$DateTime = paste0(a, post$comments$DateTime)
post$comments$DateTime = ymd_hm(post$comments$DateTime, tz = "Asia/Taipei")
...
post$comments$DateTime[26] = ymd_hm("2020-04-25 15:50", tz = "Europe/Warsaw")
...
```{r ans35}
temp = post$category_dateTime
post$category_dateTime = NULL
post = list(
  title = post$title,
  content = post$content,
  sub_gender = post$submitter_gender,
  category = temp[1],
  dateTime = ymd_hm(paste0(a, temp[2]), tz = "Asia/Taipei"),
