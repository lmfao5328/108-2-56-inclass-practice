...
studentHeights$學年度 = ordered(studentHeights$學年度)
studentHeights$年齡 = ordered(studentHeights$年齡)
...
```{r ans13}
six_to8 = studentHeights$年齡層 == "6-8"
nine_to12 = studentHeights$年齡層 == "9-12"
thirteen_to15 = studentHeights$年齡層 == "13-15"

averageHeightByGroup = c(
  mean(studentHeights$平均身高[six_to8]),
  mean(studentHeights$平均身高[nine_to12]),
  mean(studentHeights$平均身高[thirteen_to15])
)
names(averageHeightByGroup) = c(
  "6-8", "9-12", "13-15"
)
...
```{r ans14}
boi = studentHeights$類別 == "男"
grill = studentHeights$類別 =="女"

heightDifferenceByGroup = c(
  mean(studentHeights$平均身高[six_to8 & boi]) -
  mean(studentHeights$平均身高[six_to8 & grill]),
  mean(studentHeights$平均身高[nine_to12 & boi]) - 
  mean(studentHeights$平均身高[nine_to12 & grill]),
  mean(studentHeights$平均身高[thirteen_to15 & boi]) -
  mean(studentHeights$平均身高[thirteen_to15 & grill])
)
names(heightDifferenceByGroup) = c(
  "6-8", "9-12", "13-15"
)
...
```{r ans24}
temp_regex = "(^不)動(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"不動系")
temp_regex = "(^公)(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"公行系")
temp_regex = "(^社)(\\w)+工(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"社工系")
temp_regex = "(^社)會(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"社會系")
temp_regex = "(^休)(\\w)+運(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"休運系")
temp_regex = "(^金)融(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"金融系")
temp_regex = "(^經)濟(\\w)+(系$)"
differentMajors = str_replace(differentMajors,temp_regex,"經濟系")
...
levels(school) = str_replace(levels(school), "休運系|金融系", "商學院")
levels(school) = str_replace(levels(school), "經濟系|社會系|社工系", "社科院")
levels(school) = str_replace(levels(school), "公行系|不動系", "公共事務學院")
levels(school)
